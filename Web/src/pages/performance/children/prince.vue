<template>
  <div>
    <mt-loadmore  class="loadmores tab-container"  :top-method="loadTop"  ref="loadmore"  @top-status-change="handleTopChange" :class="{'iphonex-tab-container':isIphoneX,'iphonex-loadmores':isIphoneX}">
...
import {mapGetters} from 'vuex'
  ...
  export default {
    data () {
      return {
        currentView: '/home/performance/prince',
        subjectId:JSON.parse(localStorage.getItem('performanceTabsIds'))[1],
