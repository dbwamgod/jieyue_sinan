<template>
  <div class="today_wrap" :class="isIphoneX?'today_wrap_iphonex_head':''">
    <mt-loadmore class="loadmorestwo"   :top-method="loadTop"  @top-status-change="handleTopChange" ref="loadmore">
      ...
      <look-lend-money :tagsType="false" :titleText="'近7日出借金额走势 (万元)'" :lendTitle="'今日出借 (元)'"></look-lend-money>
      ...
      methods:{
        ...
        goTop(){
         ...
         changeRouterTwo(){
          ...
          this.$router.push('/timeBattle/index/month')
         },
         loadTop() {//下拉刷新
           setTimeout(()=>{
